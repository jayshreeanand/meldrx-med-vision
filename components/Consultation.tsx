...
export default function Consultation() {
  ...
  return (
    <>
      <Head>
        <title>Video Consultation - Med Vision</title>
        <meta name="description" content="Start your video consultation with a medical professional" />
          ...
          <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center">
              ...
              <nav className="flex space-x-4">
                ...
                <a href="#" className="text-blue-600 font-medium">Consultation</a>
