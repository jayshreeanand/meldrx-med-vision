          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-700 mb-8">
                Our team is here to help with any questions about our services, technology, or partnerships.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-gray-700">
                    ...
                    <p>info@medvision.example.com</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
